...
public class Game {
	...
	public void sethost(HashMap<String, String> host) {
		...
		System.out.println("[Game] [GM] "+host.get("id")+"님이 방장이 되셨습니다.");
...
//	}
	...
	public void receiveChat(HashMap<String, String> msgData) { // 채팅 받기
		String id=null;
		String msg=null;
	...
	public void setStatus(String status) { // 상태 설정
		...
		str.append("님은 ");
		str.append(status);
		if(status.equals("사망"))str.append("했습니다.");
		else str.append("입니다.");
		System.out.println(str);
	}

	
	public synchronized void addUser(String id) { // 유저 들어옴
		StringBuilder str=new StringBuilder();
		str.append("[GM] ");
		str.append(id);
	...
	public synchronized void removeUser(String id) { // 유저 나감
		StringBuilder str=new StringBuilder();
		str.append("[GM] ");
		str.append(id);
		str.append("님이 나갔습니다.");
